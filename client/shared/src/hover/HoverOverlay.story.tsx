...
const BITBUCKET_CLASS_PROPS: HoverOverlayClassProps = {
    ...
    actionItemClassName: classNames('aui-button', bitbucketCodeHostStyles.hoverActionItemBitbucketServer),
    closeButtonClassName: classNames('aui-button', bitbucketCodeHostStyles.btnIconBitbucketServer, 'close'),
