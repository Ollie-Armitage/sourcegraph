...
export const gerritCodeHost: CodeHost = {
    ...
    hoverOverlayClassProps: {
        className: styles.hoverOverlayGerrit,
        closeButtonClassName: styles.hoverOverlayCloseButton,
        actionItemClassName: styles.hoverOverlayAction,
        contentClassName: styles.hoverOverlayContents,
    },
