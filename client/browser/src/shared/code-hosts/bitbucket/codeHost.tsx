...
export const getToolbarMount = (
    ...
    mount.classList.add(styles.sgToolbarMountBitbucketServer)
...
const newDiffToolbarButtonProps = {
    listItemClass: styles.actionNavItemBitbucketServerNewDiff,
    actionItemClass: styles.actionItemBitbucketServerNewDiff,
}
...
const getCommandPaletteMount: MountGetter = (container: HTMLElement): HTMLElement | null => {
    ...
    const classNames = ['command-palette-button', styles.commandPaletteButtonBitbucketServer]
...
function getViewContextOnSourcegraphMount(container: HTMLElement): HTMLElement | null {
    ...
    mount.className = styles.openOnSourcegraphBitbucketServer
...
export const bitbucketServerCodeHost: CodeHost = {
    ...
    commandPaletteClassProps: {
        buttonClassName: classNames(
            styles.commandListPopoverButtonBitbucketServer,
        ...
        popoverClassName: classNames(
            styles.commandPalettePopoverBitbucketServer,
    ...
    codeViewToolbarClassProps: {
        className: classNames(styles.codeViewToolbarBitbucket, 'aui-buttons'),
        ...
        listItemClass: styles.actionNavItemBitbucket,
    },
    hoverOverlayClassProps: {
        className: 'aui-dialog',
        actionItemClassName: classNames('aui-button', styles.hoverActionItemBitbucketServer),
        closeButtonClassName: classNames('aui-button', styles.btnIconBitbucketServer),
